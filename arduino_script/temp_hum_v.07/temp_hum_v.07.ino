...
{// Read data and store it to variables hum and temp
  ...
  humdata=(String(hum)+ ";"+ timeClient.getFormattedDate());
  tempdata=(String(temp)+ ";"+ timeClient.getFormattedDate());
  Serial.println("hum and time:  "+ humdata);
  Serial.println("temp and time:  "+ tempdata);
  
  String path1 = "/humidity3:"; // creates a data path in firebase.
  Firebase.pushString(firebaseData, path1, humdata); // it stores humidity.
  String path2 = "/tempperature3:"; // creates a data path in firebase.
  Firebase.pushString(firebaseData, path2, tempdata); // it stores temperature.
